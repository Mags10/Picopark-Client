...
public class TilesEvents {
    private int[][] codeMapsTiles;
    private final int maxTiles = 15;
    private BufferedImage[] tiles = new BufferedImage[maxTiles];

    private final GamePanel gp;

    public TilesEvents(GamePanel gamePanel, int[][] mapTiles){
        this.gp = gamePanel;
        getTilesImages();
        this.codeMapsTiles = mapTiles;
    }
    ...
    public void getTilesImages(){
        try{
            ...
            this.tiles[5] = ImageIO.read((Objects.requireNonNull(this.getClass().getResourceAsStream("/assets-tiles/suelo.png"))));
